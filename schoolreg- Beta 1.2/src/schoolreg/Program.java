...
public class Program implements Serializable{
	...
	try
    {
        ...
        ois.close();
        fis.close();
        System.out.println("Deserilization Course arraylist compelted");
	...
	try
    {
        ...
        ois.close();
        fis.close();
        System.out.println("Deserilization Student arraylist compelted");
     }catch(IOException ioe){
         ioe.printStackTrace();
         return arraylist;
      }catch(ClassNotFoundException c){
	...
	public static void course_seralize(ArrayList All_course){
		...
		try{
	        ...
	        oos.close();
	        fos.close();
	        System.out.println("Serilization Course Arraylist compelted");
	      }catch(IOException ioe){
	           ioe.printStackTrace();
	...
	public static void student_seralize(ArrayList All_course){
		...
		try{
	        ...
	        oos.close();
	        fos.close();
	        System.out.println("Serilization Student Arraylist compelted");
	      }catch(IOException ioe){
	           ioe.printStackTrace();
